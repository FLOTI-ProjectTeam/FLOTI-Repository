...
// import
import com.floti.api.auth.dto.ApiResponse;             // 공통 응답
import com.floti.api.auth.dto.ChangePasswordRequestDto; // 비번 변경 DTO
import com.floti.api.auth.entity.User;                  // 유저 엔티티
import com.floti.api.auth.repository.UserRepository;    // 유저 레포
